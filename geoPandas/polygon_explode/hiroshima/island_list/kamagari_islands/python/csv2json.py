...
FILE_CSV = 'kamagari_islands.csv'

FILE_JSON = 'kamagari_islands.json'
...
dic['title'] = 'List of Islands of Kamagari'

dic['title_ja'] = '蒲刈群島の島の一覧'

dic['reference'] = 'wikipedia: 蒲刈群島'

dic['url_reference'] = 'https://ja.wikipedia.org/wiki/%E8%92%B2%E5%88%88%E7%BE%A4%E5%B3%B6'
