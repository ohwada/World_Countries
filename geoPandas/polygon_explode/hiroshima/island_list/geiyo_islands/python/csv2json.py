...
FILE_CSV = 'geiyo_islands.csv'

FILE_JSON = 'geiyo_islands.json'
...
dic['title'] = 'List of Islands of Geiyo'

dic['title_ja'] = '芸予諸島の島の一覧'

dic['reference'] = 'wikipedia: 芸予諸島'

dic['url_reference'] = 'https://ja.wikipedia.org/wiki/Category:%E8%8A%B8%E4%BA%88%E8%AB%B8%E5%B3%B6'
