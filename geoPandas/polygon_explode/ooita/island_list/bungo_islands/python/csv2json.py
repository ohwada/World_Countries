...
FILE_CSV = 'bungo_islands.csv'

FILE_JSON = 'bungo_islands.json'
...
dic['title'] = 'List of Islands of Bungo'

dic['title_ja'] = '豊後諸島の島の一覧'

dic['reference'] = 'wikipedia: 豊後諸島'

dic['url_reference'] = 'https://ja.wikipedia.org/wiki/Category:%E8%B1%8A%E5%BE%8C%E8%AB%B8%E5%B3%B6'
