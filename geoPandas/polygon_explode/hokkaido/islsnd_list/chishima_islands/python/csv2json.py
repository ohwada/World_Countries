...
FILE_CSV = 'chishima_islands.csv'

FILE_JSON = 'chishima_islands.json'
...
dic['title'] = 'List of Islands of Chishima'

dic['title_ja'] = '千島列島の島の一覧'

dic['reference'] = 'wikipedia: 千島列島'

dic['url_reference'] = 'https://ja.wikipedia.org/wiki/Category:%E5%8D%83%E5%B3%B6%E5%88%97%E5%B3%B6'
