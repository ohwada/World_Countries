...
FILE_CSV = 'habomai_islands.csv'

FILE_JSON = 'habomai_islands.json'
...
dic['title'] = 'List of Islands of Habomai'

dic['title_ja'] = '歯舞群島の島の一覧'

dic['reference'] = 'wikipedia: 歯舞群島'

dic['url_reference'] = 'https://ja.wikipedia.org/wiki/%E6%AD%AF%E8%88%9E%E7%BE%A4%E5%B3%B6'
