...
FILE_PREF_GEOJSON = 'data/akita.geojson'

FILE_ISLAND_LIST = 'data/akita_island_list.json'

FILE_PLACE_LIST = 'data/akita_place_list.json'
...
len_exploded = len(df_exploded)

print( 'len: ', len_exploded )
