...
FILE_CSV = 'shiwaku_islands.csv'

FILE_JSON = 'shiwaku_islands.json'
...
dic['title'] = 'List of Islands of Shiwaku'

dic['title_ja'] = '塩飽諸島の島の一覧'

dic['reference'] = 'wikipedia: 塩飽諸島'

dic['url_reference'] = 'https://ja.wikipedia.org/wiki/Category:%E5%A1%A9%E9%A3%BD%E8%AB%B8%E5%B3%B6'
