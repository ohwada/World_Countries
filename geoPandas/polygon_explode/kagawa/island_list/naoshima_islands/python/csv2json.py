...
FILE_CSV = 'naoshima_islands.csv'

FILE_JSON = 'naoshima_islands.json'
...
dic['title'] = 'List of Islands of Naoshima'

dic['title_ja'] = '直島諸島の島の一覧'

dic['reference'] = 'wikipedia: 直島諸島'

dic['url_reference'] = 'https://ja.wikipedia.org/wiki/%E7%9B%B4%E5%B3%B6%E8%AB%B8%E5%B3%B6'
