...
FILE_CSV = 'bouyo_islands.csv'

FILE_JSON = 'bouyo_islands.json'
...
dic['title'] = 'List of Islands of Bouyo'

dic['title_ja'] = '防予諸島の島の一覧'

dic['reference'] = 'wikipedia: 防予諸島'

dic['url_reference'] = 'https://ja.wikipedia.org/wiki/%E9%98%B2%E4%BA%88%E8%AB%B8%E5%B3%B6'
