...
FILE_CSV = 'oki_islands.csv'

FILE_JSON = 'oki_islands.json'
...
dic['title'] = 'List of Islands of Oki'

dic['title_ja'] = '隠岐諸島の島の一覧'

dic['reference'] = 'wikipedia: 隠岐諸島'

dic['url_reference'] = 'https://ja.wikipedia.org/wiki/Category:%E9%9A%A0%E5%B2%90%E8%AB%B8%E5%B3%B6'
