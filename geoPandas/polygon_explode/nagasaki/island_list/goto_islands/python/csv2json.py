...
FILE_CSV = 'goto_islands.csv'

FILE_JSON = 'goto_islands.json'
...
dic['title'] = 'List of Islands of Goto'

dic['title_ja'] = '五島列島の島の一覧'

dic['reference'] = 'wikipedia: 五島列島'

dic['url_reference'] = 'https://ja.wikipedia.org/wiki/Category:%E4%BA%94%E5%B3%B6%E5%88%97%E5%B3%B6'
