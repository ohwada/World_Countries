...
FILE_CSV = 'tsushima_islands.csv'

FILE_JSON = 'tsushima_islands.json'
...
dic['title'] = 'List of Islands of Tsushima'

dic['title_ja'] = '対馬(諸島)の島の一覧'

dic['reference'] = 'wikipedia: 対馬'

dic['url_reference'] = 'https://ja.wikipedia.org/wiki/%E5%AF%BE%E9%A6%AC'
