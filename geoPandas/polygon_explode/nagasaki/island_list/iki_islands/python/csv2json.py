...
FILE_CSV = 'iki_islands.csv'

FILE_JSON = 'iki_islands.json'
...
dic['title'] = 'List of Islands in Iki'

dic['title_ja'] = '壱岐諸島の島の一覧'

dic['reference'] = 'wikipedia: 壱岐市'

dic['url_reference'] = 'https://ja.wikipedia.org/wiki/%E5%A3%B1%E5%B2%90%E5%B8%82'
