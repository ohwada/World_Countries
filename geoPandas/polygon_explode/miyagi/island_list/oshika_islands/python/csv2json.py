...
FILE_CSV = 'oshika_islands.csv'

FILE_JSON = 'oshika_islands.json'
...
dic['title'] = 'List of Islands of Oshika'

dic['title_ja'] = '牡鹿諸島の島の一覧'

dic['reference'] = 'wikipedia: 牡鹿諸島'

dic['url_reference'] = 'https://ja.wikipedia.org/wiki/%E7%89%A1%E9%B9%BF%E8%AB%B8%E5%B3%B6'
