...
FILE_CSV = 'urato_islands.csv'

FILE_JSON = 'urato_islands.json'
...
dic['title'] = 'List of Islands of Urato'

dic['title_ja'] = '浦戸諸島の島の一覧'

dic['reference'] = 'wikipedia: 浦戸諸島'

dic['url_reference'] = 'https://ja.wikipedia.org/wiki/%E6%B5%A6%E6%88%B8%E8%AB%B8%E5%B3%B6'
