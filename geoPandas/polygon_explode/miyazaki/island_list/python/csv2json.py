...
FILE_JSON = 'miyazaki_island_list.json'
...
dic['title'] = 'List of Islands in Miyazaki'

dic['title_ja'] = '宮崎県の島の一覧'

dic['reference'] = 'wikipedia: 宮崎県の島'

dic['url_reference'] = 'https://ja.wikipedia.org/wiki/Category:%E5%AE%AE%E5%B4%8E%E7%9C%8C%E3%81%AE%E5%B3%B6'
