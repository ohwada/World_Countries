...
FILE_JSON_OUT = 'tokyo_island_list.json'
...
dic['title'] = 'List of Islands in Tokyo'

dic['title_ja'] = '東京都の島の一覧'

dic['reference'] = 'wikipedia: 東京都の島'

dic['url_reference'] = 'https://ja.wikipedia.org/wiki/Category:%E6%9D%B1%E4%BA%AC%E9%83%BD%E3%81%AE%E5%B3%B6'
