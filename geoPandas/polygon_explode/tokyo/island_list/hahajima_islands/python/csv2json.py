...
FILE_CSV = 'hahajima_islands.csv'

FILE_JSON = 'hahajima_islands.json'
...
dic['title'] = 'List of Islands of Hahajima'

dic['title_ja'] = '母島列島の島の一覧'

dic['reference'] = 'wikipedia: 母島列島'

dic['url_reference'] = 'https://ja.wikipedia.org/wiki/%E6%AF%8D%E5%B3%B6%E5%88%97%E5%B3%B6'
