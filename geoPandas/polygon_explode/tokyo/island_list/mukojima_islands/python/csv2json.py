...
FILE_CSV = 'mukojima_islands.csv'

FILE_JSON = 'mukojima_islands.json'
...
dic['title'] = 'List of Islands of Mukojima'

dic['title_ja'] = '聟島列島の島の一覧'

dic['reference'] = 'wikipedia: 聟島列島'

dic['url_reference'] = 'https://ja.wikipedia.org/wiki/%E8%81%9F%E5%B3%B6%E5%88%97%E5%B3%B6'
