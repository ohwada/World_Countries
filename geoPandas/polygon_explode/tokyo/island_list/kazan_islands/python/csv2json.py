...
FILE_CSV = 'kazan_islands.csv'

FILE_JSON = 'kazan_islands.json'
...
dic['title'] = 'List of Islands of Kazan'

dic['title_ja'] = '火山列島の島の一覧'

dic['reference'] = 'wikipedia: 火山列島'

dic['url_reference'] = 'https://ja.wikipedia.org/wiki/%E7%81%AB%E5%B1%B1%E5%88%97%E5%B3%B6'
