...
FILE_CSV = 'chichijima_islands.csv'

FILE_JSON = 'chichijima_islands.json'
...
dic['title'] = 'List of Islands of Chichijima'

dic['title_ja'] = '父島列島の島の一覧'

dic['reference'] = 'wikipedia: 父島列島'

dic['url_reference'] = 'https://ja.wikipedia.org/wiki/%E7%88%B6%E5%B3%B6%E5%88%97%E5%B3%B6'
