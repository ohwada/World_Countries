...
FILE_CSV = 'ogasawara_islands.csv'

FILE_JSON = 'ogasawara_islands.json'
...
dic['title'] = 'List of Islands of Ogasawara'

dic['title_ja'] = '小笠原諸島の島の一覧'

dic['reference'] = 'wikipedia: 小笠原諸島'

dic['url_reference'] = 'https://ja.wikipedia.org/wiki/Category:%E5%B0%8F%E7%AC%A0%E5%8E%9F%E8%AB%B8%E5%B3%B6'
