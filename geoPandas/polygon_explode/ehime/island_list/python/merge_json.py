...
FILE_JSON_OUT = 'ehime_island_list.json'
...
dic['title'] = 'List of Islands in Ehime'

dic['title_ja'] = '愛媛県の島の一覧'

dic['reference'] = 'wikipedia: 愛媛県の島'

dic['url_reference'] = 'https://ja.wikipedia.org/wiki/Category:%E6%84%9B%E5%AA%9B%E7%9C%8C%E3%81%AE%E5%B3%B6'
