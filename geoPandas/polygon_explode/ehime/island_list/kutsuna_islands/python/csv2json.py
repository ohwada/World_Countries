...
FILE_CSV = 'kutsuna_islands.csv'

FILE_JSON = 'kutsuna_islands.json'
...
dic['title'] = 'List of Islands of Kutsuna'

dic['title_ja'] = '忽那諸島の島の一覧'

dic['reference'] = 'wikipedia: 忽那諸島'

dic['url_reference'] = 'https://ja.wikipedia.org/wiki/Category:%E5%BF%BD%E9%82%A3%E8%AB%B8%E5%B3%B6'
