...
FILE_CSV = 'kamijima_islands.csv'

FILE_JSON = 'kamijima_islands.json'
...
dic['title'] = 'List of Islands of Kamijima'

dic['title_ja'] = '上島諸島の島の一覧'

dic['reference'] = 'wikipedia: 上島諸島'

dic['url_reference'] = 'https://ja.wikipedia.org/wiki/Category:%E4%B8%8A%E5%B3%B6%E8%AB%B8%E5%B3%B6'
