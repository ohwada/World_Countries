...
FILE_CSV = 'uoshima_islands.csv'

FILE_JSON = 'uoshima_islands.json'
...
dic['title'] = 'List of Islands of Uoshima'

dic['title_ja'] = '魚島群島の島の一覧'

dic['reference'] = 'wikipedia: 魚島群島'

dic['url_reference'] = 'https://ja.wikipedia.org/wiki/Category:%E9%AD%9A%E5%B3%B6%E7%BE%A4%E5%B3%B6'
