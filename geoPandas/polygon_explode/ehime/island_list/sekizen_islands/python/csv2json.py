...
FILE_CSV = 'sekizen_islands.csv'

FILE_JSON = 'sekizen_islands.json'
...
dic['title'] = 'List of Islands of Sekizen'

dic['title_ja'] = '関前諸島の島の一覧'

dic['reference'] = 'wikipedia: 関前諸島'

dic['url_reference'] = 'https://ja.wikipedia.org/wiki/%E9%96%A2%E5%89%8D%E8%AB%B8%E5%B3%B6'
