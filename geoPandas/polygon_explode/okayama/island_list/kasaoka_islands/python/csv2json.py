...
FILE_CSV = 'kasaoka_islands.csv'

FILE_JSON = 'kasaoka_islands.json'
...
dic['title'] = 'List of Islands of kasaoka'

dic['title_ja'] = '笠岡諸島の島の一覧'

dic['reference'] = 'wikipedia: 笠岡諸島'

dic['url_reference'] = 'https://ja.wikipedia.org/wiki/Category:%E7%AC%A0%E5%B2%A1%E8%AB%B8%E5%B3%B6'
