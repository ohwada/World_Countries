...
FILE_JSON = 'kyoto_island_list.json'
...
dic['title'] = 'List of Islands in Kyoto'

dic['title_ja'] = '京都府の島の一覧'

dic['reference'] = 'wikipedia: 京都府の島'

dic['url_reference'] = 'https://ja.wikipedia.org/wiki/Category:%E4%BA%AC%E9%83%BD%E5%BA%9C%E3%81%AE%E5%B3%B6'
