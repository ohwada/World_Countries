...
FILE_CSV = 'genkai_islands.csv'

FILE_JSON = 'genkai_islands.json'
...
dic['title'] = 'List of Islands of Genkai'

dic['title_ja'] = '玄海諸島の島の一覧'

dic['reference'] = 'wikipedia: 玄海諸島'

dic['url_reference'] = 'https://ja.wikipedia.org/wiki/%E7%8E%84%E6%B5%B7%E8%AB%B8%E5%B3%B6'
