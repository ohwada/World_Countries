...
FILE_CSV = 'miyako_islands.csv'

FILE_JSON = 'miyako_islands.json'
...
dic['title'] = 'List of Islands of Miyako'

dic['title_ja'] = '宮古諸島の島の一覧'

dic['reference'] = 'wikipedia: 宮古諸島'

dic['url_reference'] = 'https://ja.wikipedia.org/wiki/Category:%E5%AE%AE%E5%8F%A4%E8%AB%B8%E5%B3%B6'
