...
FILE_CSV = 'yaeyama_islands.csv'

FILE_JSON = 'yaeyama_islands.json'
...
dic['title'] = 'List of Islands of Yaeyama'

dic['title_ja'] = '八重山諸島の島の一覧'

dic['reference'] = 'wikipedia: 八重山諸島'

dic['url_reference'] = 'https://ja.wikipedia.org/wiki/Category:%E5%85%AB%E9%87%8D%E5%B1%B1%E8%AB%B8%E5%B3%B6'
