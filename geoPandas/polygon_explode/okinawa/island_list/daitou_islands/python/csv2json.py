...
FILE_CSV = 'daitou_islands.csv'

FILE_JSON = 'daitou_islands.json'
...
dic['title'] = 'List of Islands of daitou'

dic['title_ja'] = '大東諸島の島の一覧'

dic['reference'] = 'wikipedia: 大東諸島'

dic['url_reference'] = 'https://ja.wikipedia.org/wiki/Category:%E5%A4%A7%E6%9D%B1%E8%AB%B8%E5%B3%B6'
