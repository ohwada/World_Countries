...
FILE_CSV = 'okinawa_islands.csv'

FILE_JSON = 'okinawa_islands.json'
...
dic['title'] = 'List of Islands of Okinawa'

dic['title_ja'] = '沖縄諸島の島の一覧'

dic['reference'] = 'wikipedia: 沖縄諸島'

dic['url_reference'] = 'https://ja.wikipedia.org/wiki/Category:%E6%B2%96%E7%B8%84%E8%AB%B8%E5%B3%B6'
