...
FILE_CSV = 'aguni_islands.csv'

FILE_JSON = 'aguni_islands.json'
...
dic['title'] = 'List of Islands of Aguni'

dic['title_ja'] = '粟国諸島の島の一覧'

dic['reference'] = 'wikipedia: 粟国諸島'

dic['url_reference'] = 'https://ja.wikipedia.org/wiki/Category:%E7%B2%9F%E5%9B%BD%E8%AB%B8%E5%B3%B6'
