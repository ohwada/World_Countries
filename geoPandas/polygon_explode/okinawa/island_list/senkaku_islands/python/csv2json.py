...
FILE_CSV = 'senkaku_islands.csv'

FILE_JSON = 'senkaku_islands.json'
...
dic['title'] = 'List of Islands of Senkaku'

dic['title_ja'] = '尖閣諸島の島の一覧'

dic['reference'] = 'wikipedia: 尖閣諸島'

dic['url_reference'] = 'https://ja.wikipedia.org/wiki/Category:%E5%B0%96%E9%96%A3%E8%AB%B8%E5%B3%B6'
