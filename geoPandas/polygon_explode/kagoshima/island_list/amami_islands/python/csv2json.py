...
FILE_CSV = 'amami_islands.csv'

FILE_JSON = 'amami_islands.json'
...
dic['title'] = 'List of Islands of Amami'

dic['title_ja'] = '奄美群島の島の一覧'

dic['reference'] = 'wikipedia: 奄美群島'

dic['url_reference'] ='https://ja.wikipedia.org/wiki/Category:%E5%A5%84%E7%BE%8E%E7%BE%A4%E5%B3%B6'
