...
FILE_CSV = 'amakusa_islands.csv'

FILE_JSON = 'amakusa_islands.json'
...
dic['title'] = 'List of Islands of Amakusa'

dic['title_ja'] = '天草諸島の島の一覧'

dic['reference'] = 'wikipedia: 天草諸島'

dic['url_reference'] = 'https://ja.wikipedia.org/wiki/Category:%E5%A4%A9%E8%8D%89%E8%AB%B8%E5%B3%B6'
