...
FILE_CSV = 'ookuma_islands.csv'

FILE_JSON = 'ookuma_islands.json'
...
dic['title'] = 'List of Islands of Ookuma'

dic['title_ja'] = '大隅諸島の島の一覧'

dic['reference'] = 'wikipedia: 大隅諸島'

dic['url_reference'] = 'https://ja.wikipedia.org/wiki/Category:%E5%A4%A7%E9%9A%85%E8%AB%B8%E5%B3%B6'
