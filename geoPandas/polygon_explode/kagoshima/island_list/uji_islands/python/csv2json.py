...
FILE_CSV = 'uji_islands.csv'

FILE_JSON = 'uji_islands.json'
...
dic['title'] = 'List of Islands of Uji'

dic['title_ja'] = '宇治群島の島の一覧'

dic['reference'] = 'wikipedia: 宇治群島'

dic['url_reference'] = 'https://ja.wikipedia.org/wiki/%E5%AE%87%E6%B2%BB%E7%BE%A4%E5%B3%B6'
