...
FILE_CSV = 'koshikishima_islands.csv'

FILE_JSON = 'koshikishima_islands.json'
...
dic['title'] = 'List of Islands in Koshikishima'

dic['title_ja'] = '甑島列島の島の一覧'

dic['reference'] = 'wikipedia: 甑島列島'

dic['url_reference'] = 'https://ja.wikipedia.org/wiki/Category:%E7%94%91%E5%B3%B6%E5%88%97%E5%B3%B6'
