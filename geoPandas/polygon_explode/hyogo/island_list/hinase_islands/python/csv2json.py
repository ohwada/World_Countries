...
FILE_CSV = 'hinase_islands.csv'

FILE_JSON = 'hinase_islands.json'
...
dic['title'] = 'List of Islands in Hinase'

dic['title_ja'] = '日生諸島の島の一覧'

dic['reference'] = 'wikipedia: 日生諸島'

dic['url_reference'] = 'https://ja.wikipedia.org/wiki/Category:%E6%97%A5%E7%94%9F%E8%AB%B8%E5%B3%B6'
