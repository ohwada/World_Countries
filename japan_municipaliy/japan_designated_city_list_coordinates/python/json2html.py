...
FILE_HTML= 'japan_designated_city_coordinates_list.html'
...
for item in list_cities :
    ...
    row = template_row.format( name_en=name_en, city=row_city, pref=row_pref, flag=row_flag, coordinates=row_coordinates )
    print(row)
    rows +=  row
#
