...
dic['title'] = 'japan_ordinance_designated_city'

dic['title_ja'] = '政令指定都市の行政区の地方公共団体コード'
...
with open('japan_ordinance_designated_city_code.csv') as f1:
...
with open('japan_ordinance_designated_city_code.json', 'wt') as f2:
    json.dump(dic, f2)
