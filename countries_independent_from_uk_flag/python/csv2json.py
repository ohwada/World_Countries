...
dic['title'] = "List of countries that have gained independence from the United Kingdom with National Flag icon"
...
with open('countries_from_uk_flag.csv') as f1:
...
with open('countries_from_uk_flag.json', 'wt') as f2:
    json.dump(dic, f2)
