...
URL_KOTO = 'https://geoshape.ex.nii.ac.jp/city/topojson/20230101/13/13108A1968.topojson'
...
FILE_HTML = 'tokyo_23_wards_shape_2023.html'
...
for item2 in list_prefectures :
	...
	for item3  in list_cities: 
		...
		if name == KOTO:
			...
			data = json.loads(requests.get( URL_KOTO ).text), 
			object_path = OBJECT_PATH, 
